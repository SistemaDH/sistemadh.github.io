...
const FORMAS_DE_FERA = {
  ...
  "serpente-traicoeira": { nome: "Serpente Traiçoeira", tipo: "base", patamar: 2, nivelMinimo: 2, grupo: "Serpente Traiçoeira", verbos: ["deslizar","enganar","escalar"], modificadores: {"atributo":"Finesse +1","evasao":"+2"}, ataque: {"alcance":"Muito Próximo","atributo":"Finesse","dano":"d8+4 de dano físico"}, caracteristicas: [{"nome":"Bote Peçonhento","texto":"faça um ataque contra qualquer número de alvos em alcance Muito Próximo. Em um sucesso, o alvo fica temporariamente Envenenado. Uma criatura Envenenada sofre 1d10 de dano físico direto a cada vez que age."},{"nome":"Silvo de alerta","texto":"marque 1 Estresse para forçar qualquer número de alvos Corpo a Corpo a se afastarem até ficarem Muito Próximos."}], custoAdicional: 0 },
  ...
  "lagarto-poderoso": { nome: "Lagarto Poderoso", tipo: "base", patamar: 3, nivelMinimo: 5, grupo: "Lagarto Poderoso", verbos: ["atacar","mover-se furtivamente","rastrear"], modificadores: {"atributo":"Instinto +2","evasao":"+1"}, ataque: {"alcance":"Corpo a Corpo","atributo":"Instinto","dano":"d10+7 de dano físico"}, caracteristicas: [{"nome":"Armadura Física","texto":"você recebe um bônus de +3 em seus limiares de dano."},{"nome":"Golpe Súbito","texto":"quando acertar um ataque contra um alvo Corpo a Corpo, você pode gastar 1 Esperança para prendê-lo com a mandíbula, deixando-o temporariamente Restrito e Vulnerável."}], custoAdicional: 0 },
  ...
  "cacador-aereo-mitico": { nome: "Caçador Aéreo Mítico", tipo: "base", patamar: 4, nivelMinimo: 8, grupo: "Caçador Aéreo Mítico", verbos: ["atacar","enganar","localizar","orientar-se"], modificadores: {"atributo":"Finesse +3","evasao":"+4"}, ataque: {"alcance":"Corpo a Corpo (CaC)","atributo":"Finesse","dano":"d10+11 de dano físico"}, caracteristicas: [{"nome":"Ave de Rapina Mortal","texto":"você pode voar à vontade e se mover até um ponto em alcance Distante como parte de sua ação. Quando se mover em linha reta a partir de no mínimo alcance Próximo até ficar Corpo a Corpo com um alvo e atacá-lo na mesma ação, você pode rolar novamente todos os dados de dano com resultado menor que sua Proficiência."},{"nome":"Besta de Carga","texto":"você pode carregar até três aliados voluntários com você enquanto se movimenta."}], custoAdicional: 0 },
  "fera-aquatica-epica": { nome: "Fera Aquática Épica", tipo: "base", patamar: 4, nivelMinimo: 8, grupo: "Fera Aquática Épica", verbos: ["intimidar","localizar","proteger","rastrear"], modificadores: {"atributo":"Agilidade +3","evasao":"+3"}, ataque: {"alcance":"Corpo a Corpo (CaC)","atributo":"Agilidade","dano":"d10+10 de dano físico"}, caracteristicas: [{"nome":"Mestre do Oceano","texto":"você pode respirar e se movimentar naturalmente debaixo d’água. Quando acertar um ataque contra um alvo Corpo a Corpo, você pode deixá-lo temporariamente Restrito."},{"nome":"Robusto","texto":"quando for marcar Ponto de Armadura, role 1d6. Em um resultado 5 ou mais, reduza a gravidade em um limiar sem marcar PA."}], custoAdicional: 0 },
  "fera-massiva": { nome: "Fera Massiva", tipo: "base", patamar: 4, nivelMinimo: 8, grupo: "Fera Massiva", verbos: ["correr","intimidar","localizar","proteger"], modificadores: {"atributo":"Força +3","evasao":"+1"}, ataque: {"alcance":"Corpo a Corpo","atributo":"Força","dano":"d12+12 de dano físico"}, caracteristicas: [{"nome":"Besta de Carga","texto":"você pode carregar até quatro aliados voluntários com você enquanto se movimenta."},{"nome":"Demolir","texto":"gaste 1 Esperança para se mover até um ponto Distante em linha reta e atacar todos os alvos Corpo a Corpo à linha. Alvos atingidos sofrem d8+10 de dano físico usando sua Proficiência e ficam temporariamente Vulneráveis."},{"nome":"Impávido","texto":"você recebe um bônus de +2 em seus limiares de dano."}], custoAdicional: 0 },
  "fera-mitica": { nome: "Fera Mítica", tipo: "aprimoramento", patamar: 4, nivelMinimo: 8, grupo: "Fera Mítica (Aprimoramento de 1º ou 2º patamar)", verbos: [], modificadores: {"atributo":null,"evasao":null}, ataque: {}, caracteristicas: [{"nome":"Evoluído","texto":"escolha uma Forma de Fera de 1º ou 2º patamar e torne-se uma versão maior e mais poderosa dessa criatura. Enquanto estiver nessa forma, você mantém todos os atributos e habilidades da forma original e recebe os seguintes bônus:\n • Bônus de +9 em jogadas de dano\n • Bônus de +2 no traço usado pela forma\n • Bônus de +3 na Evasão\n • Seu dado de dano aumenta em um passo (d6 para d8, d8 para d10 etc.)."}], custoAdicional: 0 },
  "hibrido-mitico": { nome: "Híbrido Mítico", tipo: "base", patamar: 4, nivelMinimo: 8, grupo: "Híbrido Mítico", verbos: [], modificadores: {"atributo":"Força +3","evasao":"+2"}, ataque: {"alcance":"Corpo a Corpo","atributo":"Força","dano":"d12+10 de dano físico"}, caracteristicas: [{"nome":"Habilidades Híbridas","texto":"marque 2 Estresses adicionais para se transformar nesta criatura. Escolha três opções quaisquer de Forma de Fera de 1º a 3º patamar. Escolha um total de cinco vantagens e três habilidades dessas opções."}], custoAdicional: 2 },
  "lagarto-terrivel": { nome: "Lagarto Terrível", tipo: "base", patamar: 4, nivelMinimo: 8, grupo: "Lagarto Terrível", verbos: ["atacar","enganar","intimidar","rastrear"], modificadores: {"atributo":"Força +3","evasao":"+2"}, ataque: {"alcance":"Corpo a Corpo","atributo":"Força","dano":"d12+10 de dano físico"}, caracteristicas: [{"nome":"Disparada Massiva","texto":"você pode se mover até um ponto em alcance Distante sem precisar fazer uma jogada. Você ignora terreno difícil (a critério do mestre) devido ao seu tamanho."},{"nome":"Golpes Devastadores","texto":"quando causar dano Severo a um alvo Corpo a Corpo, você pode marcar 1 Estresse para forçá-lo a marcar 1 Ponto de Vida adicional."}], custoAdicional: 0 },
};
