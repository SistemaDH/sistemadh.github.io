...
const EQUIPAMENTO_ALIASES = {
  ...
  "primaria-t1-machado-sagrado": ["Machado sagrado","Hallowed Axe"],
  ...
  "primaria-t1-bastao-curto": ["Bastão Curto","Shortstaff","Pessoal de baixa estatura"],
  ...
  "primaria-t1-bastao-longo": ["Bastão Longo","Greatstaff"],
  ...
  "secundaria-t1-punhal-pequeno": ["Punhal pequeno","Small Dagger"],
