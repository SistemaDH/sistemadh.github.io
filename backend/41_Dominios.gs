...
const USOS_CARTAS_DOMINIO = {
  ...
  "arcana-olho-flutuante": {"custo":{"esperanca":1},"rotuloAtivar":"Criar Olho Flutuante · 1 Esperança","estado":{"chave":"estado:carta:arcana:olho-flutuante","valor":1,"rotuloAtivo":"Olho Flutuante ativo","rotuloEncerrar":"Encerrar Olho Flutuante","avisoEncerrar":"Olho Flutuante encerrado."},"lembrete":"Mova a orbe em alcance Longínquo e alterne livremente entre seus sentidos e a visão dela. Encerre se ela sofrer dano ou sair do alcance."},
  ...
  "arcana-relampago-em-cadeia": {"custo":{"estresse":2},"rotuloAtivar":"Marcar 2 Estresses e conjurar","lembrete":"O app não rola a jogada de Conjuração, as jogadas de reação nem 2d8+4 de dano."},
  ...
  "blade-redemoinho": {"custo":{"esperanca":1},"rotuloAtivar":"Sucesso: usar Redemoinho","lembrete":"Use o mesmo ataque contra os outros alvos em alcance Muito Próximo; cada alvo adicional acertado sofre metade do dano."},
  ...
  "blade-frenesi": {"custo":{},"marcaUso":{"chave":"uso:carta:blade:frenesi","maximo":1},"estado":{"chave":"estado:carta:blade:frenesi","valor":1,"permiteEncerrarManual":true,"rotuloAtivo":"Em Frenesi","avisoEncerrar":"Frenesi encerrado."},"rotuloAtivar":"Entrar em Frenesi","lembrete":"Enquanto ativo: +10 na jogada de dano, +8 no limiar Severo e não use Pontos de Armadura."},
  ...
  "bone-manobras-ageis": {"custo":{"estresse":1},"marcaUso":{"chave":"uso:carta:bone:manobras-ageis","maximo":1},"rotuloAtivar":"Usar Manobras Ágeis","lembrete":"Mova-se até alcance Distante sem jogada de Agilidade. Se terminar Corpo a Corpo e atacar imediatamente, use +1 no ataque."},
  ...
  "bone-preparar": {"custo":{"estresse":1},"efeitoRecurso":{"chave":"armaduraMarcada","delta":1},"rotuloAtivar":"Preparar: marcar Armadura adicional","lembrete":"Use junto da redução de dano que já marcou 1 Ponto de Armadura; este botão marca o ponto adicional."},
  ...
  "bone-conheca-teu-inimigo": {"custo":{},"opcoes":[{"id":"informacao","rotulo":"Informação · 1 Esperança","custo":{"esperanca":1},"lembrete":"Escolha um dos quatro conjuntos de informações e pergunte ao Mestre."},{"id":"medo","rotulo":"Remover 1 Medo · 1 Estresse","custo":{"estresse":1},"lembrete":"A jogada de Instinto teve sucesso; o Mestre remove 1 Medo da Reserva de Medo."},{"id":"ambos","rotulo":"Informação + Medo · 1 Esperança + 1 Estresse","custo":{"esperanca":1,"estresse":1},"lembrete":"Escolha um conjunto de informações e o Mestre remove 1 Medo da Reserva de Medo."}],"rotuloAtivar":"Registrar sucesso de Conheça Teu Inimigo"},
  ...
  "bone-corrida-da-morte": {"custo":{"esperanca":3},"rotuloAtivar":"Iniciar Corrida da Morte","lembrete":"Primeiro alvo usa +1 Proficiência na jogada de dano; remova um dado para cada alvo subsequente e não ataque o mesmo adversário duas vezes."},
  ...
  "codex-manifestar-muralha": {"custo":{"esperanca":1},"marcaUso":{"chave":"uso:carta:codex:manifestar-muralha","maximo":1},"estado":{"chave":"estado:carta:codex:manifestar-muralha","valor":1,"permiteEncerrarManual":true,"rotuloAtivo":"Manifestar Muralha ativa","rotuloEncerrar":"Encerrar Manifestar Muralha","avisoEncerrar":"Manifestar Muralha foi encerrada."},"rotuloAtivar":"Sucesso: Manifestar Muralha · 1 Esperança","lembrete":"Crie a muralha entre dois pontos em alcance Distante. Ela dura até seu próximo descanso ou até ser encerrada/reconjurada."},
  "codex-teleporte": {"custo":{},"marcaUso":{"chave":"uso:carta:codex:teleporte","maximo":1},"rotuloAtivar":"Registrar Teleporte · 1/descanso longo","lembrete":"Escolha um local já visitado e faça a jogada de Conjuração 16 fora do app, aplicando +3/+1/0/−2 conforme a familiaridade. Em falha, a mesa define o desvio pela margem."},
  ...
  "codex-refugio-seguro": {"custo":{"esperanca":2},"estado":{"chave":"estado:carta:codex:refugio-seguro","valor":1,"permiteEncerrarManual":true,"movimentosAdicionaisNoDescanso":1,"rotuloAtivo":"Dentro do Refúgio Seguro","rotuloEncerrar":"Sair/encerrar Refúgio Seguro","avisoEncerrar":"Refúgio Seguro deixou de conceder o movimento adicional."},"rotuloAtivar":"Invocar Refúgio Seguro · 2 Esperanças","lembrete":"Enquanto descansar no seu próprio Refúgio Seguro, você recebe um movimento de descanso adicional."},
  "codex-livro-do-ronin": {"custo":{},"opcoes":[{"id":"transformacao","estado":{"chave":"estado:carta:codex:livro-do-ronin-transformacao","valor":1,"encerraAoSofrerDano":true,"rotuloAtivo":"Transformação do Ronin ativa","rotuloEncerrar":"Encerrar Transformação","avisoEncerrar":"Transformação do Ronin encerrada."},"rotuloAtivar":"Sucesso: assumir Transformação","lembrete":"Use após uma jogada de Conjuração 15 bem-sucedida. Você permanece como objeto inanimado até sofrer dano."},{"id":"enervacao","marcaUso":{"chave":"uso:carta:codex:livro-do-ronin-enervacao","maximo":1},"rotuloAtivar":"Sucesso: registrar Enervação Eterna · 1/descanso longo","lembrete":"Use após a jogada de Conjuração contra o alvo Próximo ser bem-sucedida. No encontro, deixe o alvo permanentemente Vulnerável."}]},
  ...
  "grace-discurso-acalmante": {"custo":{},"efeitoRecurso":{"chave":"pontosDeVidaMarcados","delta":-2},"rotuloAtivar":"Após cuidar de aliado: limpar 2 PV","lembrete":"Use somente após Cuidar de Ferimentos em outro personagem durante descanso curto. Esse personagem também limpa 1 PV adicional."},
  "grace-pelos-seus-olhos": {"custo":{},"estado":{"chave":"estado:carta:grace:pelos-seus-olhos","valor":1,"permiteEncerrarManual":true,"encerraAoConjurarOutroFeitico":true,"rotuloAtivo":"Pelos Seus Olhos ativo","rotuloEncerrar":"Encerrar Pelos Seus Olhos","avisoEncerrar":"Pelos Seus Olhos encerrado."},"rotuloAtivar":"Ativar Pelos Seus Olhos","lembrete":"Escolha um alvo em alcance Longínquo e registre-o na mesa. Encerra no próximo descanso ou ao conjurar outro feitiço."},
  "grace-mergulhador-de-pensamentos": {"custo":{"esperanca":1},"rotuloAtivar":"Ler pensamentos superficiais · 1 Esperança","lembrete":"Escolha um alvo em alcance Distante. Para pensamentos profundos, faça a jogada de Conjuração fora do app; este botão representa apenas a leitura superficial."},
  "grace-nunca-ofuscado": {"custo":{"estresse":1},"entradaQuantidade":{"campo":"pontosDeVidaPerdidos","rotulo":"PV marcados neste ataque","minimo":1,"maximo":12,"ajuda":"Informe quantos PV você marcou pelo ataque; a mesma quantidade deve ser adicionada ao contador Nunca Ofuscado."},"rotuloAtivar":"Registrar Nunca Ofuscado · 1 Estresse","lembrete":"Adicione ao contador Nunca Ofuscado marcadores iguais aos PV informados. No próximo ataque bem-sucedido, +5 na jogada de dano por marcador e depois limpe o contador."},
  ...
  "midnight-estrangulamento": {"custo":{"estresse":1},"rotuloAtivar":"Aplicar Estrangulamento · 1 Estresse","lembrete":"Use apenas estando atrás de uma criatura aproximadamente do seu tamanho. O alvo fica temporariamente Vulnerável e ataques contra ele causam +2d6 de dano enquanto essa condição vier do Estrangulamento."},
  ...
  "midnight-expert-em-furtividade": {"custo":{"estresse":1},"rotuloAtivar":"Trocar Medo por Esperança · 1 Estresse","lembrete":"Use somente após você ou um aliado em alcance Próximo fazer uma jogada com Medo ao tentar mover-se despercebido em uma área perigosa; trate o resultado como uma jogada com Esperança."},
  "midnight-glifo-do-crepusculo": {"custo":{"esperanca":1},"rotuloAtivar":"Sucesso: conjurar Glifo do Crepúsculo · 1 Esperança","lembrete":"Use após obter sucesso na jogada de Conjuração. Reduza temporariamente a Dificuldade do alvo em seu Conhecimento, com mínimo de 1."},
  "midnight-retirada-fantasma": {"custo":{},"opcoes":[{"id":"ativar","rotulo":"Ativar ponto de retorno","custo":{"esperanca":1},"lembrete":"Registre na mesa o local atual como ponto da Retirada Fantasma."},{"id":"retornar","rotulo":"Retornar ao ponto","custo":{"esperanca":1},"lembrete":"Use somente com Retirada Fantasma já ativa e antes do próximo descanso; reapareça no ponto registrado e encerre o feitiço."}],"rotuloAtivar":"Usar Retirada Fantasma","lembrete":"A posição do ponto de retorno permanece na mesa; cada uma das duas etapas custa 1 Esperança."},
  ...
  "midnight-disfarce-em-massa": {"custo":{"estresse":1},"estado":{"chave":"carta:midnight-disfarce-em-massa","valor":8,"permiteEncerrarManual":true,"rotuloAtivo":"Disfarce em Massa ativo","rotuloEncerrar":"Encerrar Disfarce em Massa","avisoEncerrar":"Disfarce em Massa encerrado."},"rotuloAtivar":"Criar Disfarce em Massa · 1 Estresse","lembrete":"A Contagem Regressiva começa em 8. O Mestre pode escolher reduzi-la como consequência; em 0, o disfarce termina."},
  "midnight-sussurros-sombrios": {"custo":{"estresse":1},"rotuloAtivar":"Sondar pelos Sussurros · 1 Estresse","lembrete":"Use para a parte de sondagem após existir contato físico com o alvo. Faça a jogada de Conjuração fora do app e, em caso de sucesso, faça uma das quatro perguntas ao Mestre."},
  "midnight-esquiva-desaparecente": {"custo":{"esperanca":1},"estado":{"chave":"estado:carta:midnight:esquiva-desaparecente","valor":1,"permiteEncerrarManual":true,"rotuloAtivo":"Esquiva Desaparecente ativa","rotuloEncerrar":"Encerrar após a próxima ação","avisoEncerrar":"Esquiva Desaparecente encerrada."},"rotuloAtivar":"Ataque que causaria dano físico falhou · 1 Esperança","lembrete":"Teleporte para um ponto em alcance Próximo do atacante e fique Oculto até sua próxima jogada de ação; depois encerre este estado."},
  ...
  "midnight-terror-noturno": {"custo":{},"marcaUso":{"chave":"uso:carta:midnight:terror-noturno","maximo":1},"rotuloAtivar":"Registrar Terror Noturno · 1/descanso longo","lembrete":"Resolva as jogadas de reação 16 e o Medo do Mestre na mesa. Alvos que falham ficam Aterrorizados e Vulneráveis e recebem o dano dos d6 rolados fora do app."},
  "midnight-eclipse": {"custo":{},"marcaUso":{"chave":"uso:carta:midnight:eclipse","maximo":1},"estado":{"chave":"estado:carta:midnight:eclipse","valor":1,"permiteEncerrarManual":true,"rotuloAtivo":"Eclipse ativo","rotuloEncerrar":"Encerrar Eclipse","avisoEncerrar":"Eclipse encerrado."},"rotuloAtivar":"Sucesso: ativar Eclipse · 1/descanso longo","lembrete":"Use após sucesso na jogada de Conjuração 16. Encerre quando o Mestre gastar 1 Medo no turno dele ou quando você sofrer dano Severo."},
  ...
  "sage-emaranhado-cruel": {"custo":{"esperanca":1},"rotuloAtivar":"Sucesso: atingir segundo alvo · 1 Esperança","lembrete":"Use somente após sucesso no alvo principal. Escolha outro adversário em alcance Muito Próximo dele e deixe-o temporariamente Restrito."},
  "sage-lingua-da-natureza": {"custo":{"esperanca":1},"rotuloAtivar":"Ambiente natural: +2 Conjuração · 1 Esperança","lembrete":"Use antes de uma jogada de Conjuração em ambiente natural; aplique +2 apenas nessa jogada."},
  "sage-rastreador-habilidoso": {"custo":{},"entradaQuantidade":{"campo":"quantidadePerguntas","rotulo":"quantidade de perguntas","minimo":1,"maximo":6,"custoPorUnidade":{"esperanca":1},"ajuda":"Gaste 1 Esperança para cada pergunta feita ao Mestre."},"rotuloAtivar":"Fazer perguntas de rastreamento","lembrete":"Faça ao Mestre exatamente a quantidade de perguntas paga. Ao encontrar as criaturas rastreadas, +1 Evasão vale somente contra elas."},
  "sage-conjurar-enxame": {"custo":{},"opcoes":[{"id":"besouros","rotulo":"Besouros Blindados Tekaira","custo":{"estresse":1},"estado":{"chave":"estado:carta:sage:conjurar-enxame:besouros","valor":1,"permiteEncerrarManual":true,"rotuloAtivo":"Besouros Blindados ativos","rotuloEncerrar":"Dispensar Besouros","avisoEncerrar":"Besouros Blindados dispensados."},"lembrete":"No próximo dano, reduza a gravidade em um limiar. Depois, encerre os Besouros ou gaste 1 Esperança manualmente para mantê-los."},{"id":"vagalumes","rotulo":"Vagalumes","custo":{"esperanca":1},"lembrete":"Faça a jogada de Conjuração contra adversários em alcance Próximo; alvos atingidos sofrem 2d8+3 de dano mágico rolado fora do app."}],"rotuloAtivar":"Conjurar Enxame"},
  "sage-familiar-natural": {"custo":{},"opcoes":[{"id":"terrestre","rotulo":"Familiar terrestre","custo":{"esperanca":1},"estado":{"chave":"estado:carta:sage:familiar-natural","valor":1,"permiteEncerrarManual":true,"rotuloAtivo":"Familiar Natural ativo","rotuloEncerrar":"Dispensar Familiar","avisoEncerrar":"Familiar Natural dispensado."},"lembrete":"Invoque um pequeno espírito/animal. Ele dura até o próximo descanso, nova conjuração ou ser alvo de um ataque."},{"id":"voador","rotulo":"Familiar voador","custo":{"esperanca":2},"estado":{"chave":"estado:carta:sage:familiar-natural","valor":1,"permiteEncerrarManual":true,"rotuloAtivo":"Familiar Natural voador ativo","rotuloEncerrar":"Dispensar Familiar","avisoEncerrar":"Familiar Natural dispensado."},"lembrete":"Familiar com voo: custo total 2 Esperanças. Dura até o próximo descanso, nova conjuração ou ser alvo de um ataque."}],"rotuloAtivar":"Invocar Familiar Natural"},
  "sage-caule-imponente": {"custo":{},"marcaUso":{"chave":"uso:carta:sage:caule-imponente","maximo":1},"opcoes":[{"id":"utilidade","rotulo":"Criar caule escalável","custo":{},"lembrete":"Crie o caule Próximo, com altura até Distante; nenhuma rolagem automática."},{"id":"ataque","rotulo":"Usar como ataque","custo":{"estresse":1},"lembrete":"Faça a jogada de Conjuração contra os alvos em alcance Próximo e cause d8 físico usando Proficiência aos atingidos."}],"rotuloAtivar":"Conjurar Caule Imponente · 1/descanso"},
  "sage-projetil-corrosivo": {"custo":{},"entradaQuantidade":{"campo":"estressesCorrosao","rotulo":"Estresses gastos na corrosão","minimo":2,"maximo":12,"custoPorUnidade":{"estresse":1},"ajuda":"O alvo recebe −1 Dificuldade para cada 2 Estresses pagos."},"rotuloAtivar":"Sucesso: aplicar Corrosão permanente","lembrete":"Registre no adversário −1 Dificuldade para cada 2 Estresses pagos. Corroído é permanente e acumulável."},
  "sage-campo-de-cura": {"custo":{},"marcaUso":{"chave":"uso:carta:sage:campo-de-cura","maximo":1},"opcoes":[{"id":"normal","rotulo":"Campo normal · curar 1 PV","custo":{},"efeitoRecurso":{"chave":"pontosDeVidaMarcados","delta":-1},"lembrete":"Você recupera 1 PV; cada aliado Próximo também recupera 1 PV na própria ficha."},{"id":"ampliado","rotulo":"Campo ampliado · 2 Esperanças · curar 2 PV","custo":{"esperanca":2},"efeitoRecurso":{"chave":"pontosDeVidaMarcados","delta":-2},"lembrete":"Você recupera 2 PV; cada aliado Próximo também recupera 2 PV na própria ficha."}],"rotuloAtivar":"Conjurar Campo de Cura · 1/descanso longo"},
  "sage-fortaleza-selvagem": {"custo":{"esperanca":2},"rotuloAtivar":"Sucesso: criar Fortaleza Selvagem · 2 Esperanças","lembrete":"Zere o contador de PV da cúpula ao criá-la. Marque 1/2/3 PV conforme os limiares 15/30/Severo; no 3º PV a cúpula cai."},
  "sage-pele-espinhosa": {"custo":{"esperanca":1},"marcaUso":{"chave":"uso:carta:sage:pele-espinhosa","maximo":1},"rotuloAtivar":"Ativar Pele Espinhosa · 1 Esperança · 1/descanso","lembrete":"Coloque marcadores iguais à Conjuração. Ao sofrer dano, gaste quantos quiser e role essa quantidade de d6 fora do app."},
  "sage-montarias-conjuradas": {"custo":{},"entradaQuantidade":{"campo":"quantidadeMontarias","rotulo":"quantidade de montarias","minimo":1,"maximo":6,"custoPorUnidade":{"esperanca":1}},"estado":{"chave":"estado:carta:sage:montarias-conjuradas","valorBase":0,"somarQuantidade":true,"permiteEncerrarManual":true,"rotuloAtivo":"Montarias Conjuradas ativas","rotuloEncerrar":"Dispensar montarias","avisoEncerrar":"Montarias Conjuradas dispensadas."},"rotuloAtivar":"Conjurar montarias","lembrete":"Cada Esperança cria uma montaria. Duram até o próximo descanso longo ou até a condição de dano da carta encerrá-las."},
  "sage-surto-selvagem": {"custo":{"estresse":1},"marcaUso":{"chave":"uso:carta:sage:surto-selvagem","maximo":1},"estado":{"chave":"carta:sage-surto-selvagem","valor":1,"permiteEncerrarManual":true,"rotuloAtivo":"Surto Selvagem ativo","rotuloEncerrar":"Encerrar Surto Selvagem","avisoEncerrar":"Surto Selvagem encerrado; marque o Estresse final exigido pela carta."},"rotuloAtivar":"Ativar Surto Selvagem · 1 Estresse · 1/descanso longo","lembrete":"Dado começa em 1. Após cada jogada de ação em que usar o bônus, aumente-o; ao terminar, marque o Estresse adicional."},
  "sage-tocado-pelo-saber": {"custo":{},"exigeCartasAtivasDominio":{"dominio":"SAGE","quantidade":4},"marcaUso":{"chave":"uso:carta:sage:tocado-pelo-saber","maximo":1},"opcoes":[{"id":"agilidade","rotulo":"Dobrar Agilidade","lembrete":"Nesta jogada, use o dobro da Agilidade; escolha antes de rolar."},{"id":"instinto","rotulo":"Dobrar Instinto","lembrete":"Nesta jogada, use o dobro do Instinto; escolha antes de rolar."}],"rotuloAtivar":"Tocado pelo Saber · 1/descanso"},
  "sage-barreira-rejuvenescedora": {"custo":{},"marcaUso":{"chave":"uso:carta:sage:barreira-rejuvenescedora","maximo":1},"estado":{"chave":"estado:carta:sage:barreira-rejuvenescedora","valor":1,"permiteEncerrarManual":true,"rotuloAtivo":"Barreira Rejuvenescedora ativa","rotuloEncerrar":"Encerrar Barreira","avisoEncerrar":"Barreira Rejuvenescedora encerrada."},"rotuloAtivar":"Sucesso: ativar Barreira · 1/descanso","lembrete":"Role d4 fora do app para a cura. Enquanto ativa, dano físico vindo de fora da barreira encontra resistência; posição e aliados permanecem na cena."},
  "sage-forest-sprites": {"custo":{},"entradaQuantidade":{"campo":"quantidadeFadas","rotulo":"quantidade de fadas","minimo":1,"maximo":6,"custoPorUnidade":{"esperanca":1}},"estado":{"chave":"estado:carta:sage:espiritos-da-floresta","valorBase":0,"somarQuantidade":true,"permiteEncerrarManual":true,"rotuloAtivo":"Espíritos da Floresta ativos","rotuloEncerrar":"Dispensar fadas","avisoEncerrar":"Espíritos da Floresta dispensados."},"rotuloAtivar":"Sucesso: criar Espíritos da Floresta","lembrete":"Cada Esperança cria uma fada. Diminua 1 quando ela conceder um benefício ou sofrer dano."},
  "sage-dominio-das-plantas": {"custo":{},"marcaUso":{"chave":"uso:carta:sage:dominio-das-plantas","maximo":1},"rotuloAtivar":"Sucesso: usar Domínio das Plantas · 1/descanso longo","lembrete":"Remodele a vegetação em qualquer ponto Distante conforme a ficção acordada com o Mestre."},
  "sage-forca-da-natureza": {"custo":{"estresse":1},"estado":{"chave":"estado:carta:sage:forca-da-natureza","valor":1,"permiteEncerrarManual":true,"rotuloAtivo":"Força da Natureza ativa","rotuloEncerrar":"Encerrar Força da Natureza","avisoEncerrar":"Força da Natureza encerrada."},"rotuloAtivar":"Transformar-se · 1 Estresse","lembrete":"Antes de cada jogada de ação, gaste 1 Esperança; se não puder, encerre. Em sucesso de ataque/Conjuração, +10 no dano."},
  ...
  "valor-eu-sou-seu-escudo": {"custo":{"estresse":1},"rotuloAtivar":"Tomar o ataque do aliado · 1 Estresse","lembrete":"Você se torna o alvo do ataque que causaria dano a um aliado Muito Próximo. Ao sofrer o dano, resolva normalmente e escolha quantos Pontos de Armadura marcar."},
...
const REGRAS_ESPECIAIS_CARTAS_DOMINIO = {
  "grace-notorio": {"compra":{"descontoBolsas":1,"minimoPunhados":1,"comidaBebidaGratis":true}},
};
