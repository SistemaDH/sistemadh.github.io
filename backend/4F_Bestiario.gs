...
/** As 264 fichas: [id, nome, tipo, patamar, Dificuldade, limiares, PV, Estresse, maior custo de Medo]. */
const ADVERSARIOS = [
  ...
  ["banshee", "Banshee", "Oportunista", 2, 14, "9/18", 5, 3, 1],
  ["basilisk", "Basilisco", "Comum", 2, 14, "8/19", 4, 4, 1],
  ["berserker-alpha", "Alfa Berserker", "Líder", 2, 14, "13/26", 6, 4, 1],
  ["berserker-initiate", "Iniciado Berserker", "Comum", 2, 13, "9/18", 4, 3, 0],
  ["centaur-warden", "Centauro Guardião", "Atirador", 2, 14, "10/19", 5, 3, 1],
  ["chicken-foot-hut", "Cabana com Pés de Galinha", "Brutamonte", 2, 16, "14/27", 8, 2, 0],
  ["dire-pangolati", "Pangolati Atroz", "Brutamonte", 2, 14, "14/28", 7, 4, 1],
  ["doppelhound", "Cão Duplicador", "Oportunista", 2, 14, "9/17", 4, 5, 1],
  ["dragon-knight", "Cavaleiro Dracônico", "Brutamonte", 2, 15, "15/30", 5, 3, 1],
  ["elephant", "Elefante", "Brutamonte", 2, 15, "14/28", 6, 3, 1],
  ["entombed-cat-beast", "Fera Felina Sepultada", "Solo", 2, 15, "12/23", 7, 3, 0],
  ["entombed-elite-guard", "Guarda de Elite Sepultado", "Comum", 2, 15, "9/18", 4, 3, 0],
  ["entombed-empress", "Imperatriz Sepultada", "Líder", 2, 16, "12/24", 6, 5, 1],
  ["entombed-necropriest", "Necrossacerdote Sepultado", "Assistente", 2, 13, "8/16", 3, 7, 1],
  ["entombed-skin-beetles", "Besouros de Pele Sepultados", "Horda", 2, 14, "10/20", 5, 3, 0],
  ["entombed-stonemason", "Pedreiro Sepultado", "Lacaio", 2, 12, "", 1, 1, 1],
  ["flock-of-feather-fiends", "Bando de Demônios Plumados", "Horda", 2, 14, "10/20", 5, 3, 0],
  ["fowlbear", "Urso-Ave", "Brutamonte", 2, 15, "14/28", 7, 4, 1],
  ["fungispunj-sporeling", "Fungispunj Esporulino", "Lacaio", 2, 13, "", 1, 1, 1],
  ["fungispunj-sporophore", "Fungispunj Sporóforo", "Líder", 2, 16, "12/24", 6, 5, 1],
  ["gargoyle", "Gárgula", "Brutamonte", 2, 13, "14/28", 8, 2, 0],
  ["giant-octopus", "Polvo Gigante", "Solo", 2, 14, "13/26", 10, 5, 1],
  ["gobstalker", "Gobstalker", "Solo", 2, 15, "10/20", 8, 6, 1],
  ["guahalan-alebrujo", "Guahalan Alebrujo", "Solo", 2, 14, "13/26", 6, 5, 1],
  ["guahalan-fang-lord", "Senhor das Presas Guahalan", "Líder", 2, 16, "12/24", 6, 5, 2],
  ["guahalan-shifter", "Metamorfo Guahalan", "Comum", 2, 15, "9/18", 4, 3, 1],
  ["guahalan-spirit-beast", "Fera Espiritual Guahalan", "Lacaio", 2, 13, "", 1, 2, 1],
  ["guahalan-spirit-singer", "Cantor Espiritual Guahalan", "Assistente", 2, 14, "9/18", 4, 6, 1],
  ["hill-titan", "Titã da Colina", "Solo", 2, 14, "13/26", 10, 5, 1],
  ["hive-walker", "Caminhante da Colmeia", "Comum", 2, 12, "11/24", 3, 3, 0],
  ["jack-o-lantern", "Cabeça de Abóbora", "Lacaio", 2, 14, "", 1, 1, 1],
  ["landshark", "Tubarão Terrestre", "Brutamonte", 2, 14, "14/25", 7, 3, 1],
  ["landshark-behemoth", "Tubarão Terrestre Behemoth", "Solo", 2, 15, "15/28", 10, 4, 0],
  ["ravenous-mockery", "Arremedo Voraz", "Comum", 2, 14, "8/19", 4, 4, 1],
  ["rust-eater", "Devorador de Ferrugem", "Comum", 2, 12, "10/18", 5, 2, 0],
  ["scarecrow", "Espantalho", "Comum", 2, 15, "7/15", 4, 3, 1],
  ["sprite", "Fada", "Lacaio", 2, 13, "", 1, 1, 1],
  ["stone-titan", "Titã de Pedra", "Solo", 2, 17, "17/32", 5, 5, 1],
  ["triceratops", "Triceratops", "Brutamonte", 2, 15, "14/28", 7, 5, 0],
  ["tyrannosaurus", "Tiranossauro", "Brutamonte", 2, 15, "14/28", 7, 5, 1],
  ["urco", "Urco", "Comum", 2, 15, "9/18", 4, 3, 1],
  ["valdenhax", "Valdenhax", "Líder", 2, 16, "12/24", 6, 4, 1],
  ["archmage", "Arquimago", "Solo", 3, 18, "24/45", 5, 8, 1],
  ["catrin", "Catrin", "Manipulador", 3, 17, "20/32", 5, 6, 1],
  ["chimera", "Quimera", "Brutamonte", 3, 17, "22/40", 9, 5, 1],
  ["crimson-lepus", "Lebre Carmesim", "Solo", 3, 18, "20/35", 10, 6, 1],
  ["cryptimoth", "Mariposa Críptica", "Oportunista", 3, 14, "16/30", 5, 3, 2],
  ["cursed-merfolk", "Sereiano Amaldiçoado", "Comum", 3, 16, "18/35", 5, 4, 1],
  ["deep-dweller", "Habitante das Profundezas", "Líder", 3, 17, "22/42", 6, 6, 2],
  ["drake", "Draco", "Oportunista", 3, 14, "16/30", 5, 3, 0],
  ["dullahan", "Dullahan", "Brutamonte", 3, 17, "22/40", 7, 4, 1],
  ["fellmounted-shadow-king", "Rei Sombrio de Montaria Maldita", "Assistente", 3, 15, "24/38", 8, 5, 2],
  ["fire-titan", "Titã de Fogo", "Solo", 3, 18, "19/35", 10, 5, 1],
  ["frost-titan", "Titã Gélido", "Brutamonte", 3, 17, "22/40", 10, 4, 0],
  ["gargantuan-sea-turtle", "Tartaruga Marinha Colossal", "Solo", 3, 18, "21/41", 10, 6, 2],
  ["lamia", "Lâmia", "Oportunista", 3, 17, "18/35", 6, 5, 1],
  ["lamplight-beguiler", "Sedutor da Lamparina", "Oportunista", 3, 16, "16/32", 6, 5, 1],
  ["manticore", "Mantícora", "Solo", 3, 17, "20/35", 12, 6, 1],
  ["night-children", "Filhos da Noite", "Horda", 3, 16, "17/32", 7, 4, 0],
  ["pain-priest", "Sacerdote da Dor", "Manipulador", 3, 16, "16/32", 6, 5, 0],
  ["phoenix", "Fênix", "Atirador", 3, 18, "19/30", 6, 6, 0],
  ["plesiosaurus", "Plesiossauro", "Comum", 3, 16, "18/35", 7, 5, 0],
  ["roc", "Roc", "Solo", 3, 18, "20/35", 12, 6, 1],
  ["sandwyrm", "Verme das Areias", "Brutamonte", 3, 17, "21/40", 6, 3, 0],
  ["shapeshifting-fiend", "Demônio Metamorfo", "Manipulador", 3, 17, "20/32", 4, 8, 1],
  ["shapeshifting-fiend-revealed", "Demônio Metamorfo Revelado", "Solo", 3, 17, "20/32", 10, 8, 1],
  ["storm-titan", "Titã da Tempestade", "Solo", 3, 20, "35/70", 11, 8, 1],
  ["unicorn", "Unicórnio", "Comum", 3, 17, "19/36", 7, 5, 0],
  ["vampire-bat-swarm", "Enxame de Morcegos Vampiros", "Horda", 3, 15, "16/30", 8, 3, 0],
  ["vampire-lord", "Lorde Vampiro", "Solo", 3, 18, "24/45", 7, 7, 1],
  ["viscera-sucker", "Chupa-Vísceras", "Oportunista", 3, 14, "16/30", 5, 3, 1],
  ["whisper-wraith", "Aparição Sussurrante", "Oportunista", 3, 16, "20/32", 6, 6, 1],
  ["wyvern", "Serpe Alada", "Comum", 3, 16, "18/35", 7, 5, 1],
  ["young-fire-dragon", "Dragão de Fogo Jovem", "Solo", 3, 18, "21/34", 10, 6, 1],
  ["cephilith-abomination", "Abominação Cefilita", "Brutamonte", 4, 19, "35/70", 7, 5, 1],
  ["cephilith-hatchling", "Filhote Cefilita", "Lacaio", 4, 18, "None", 1, 1, 1],
  ["cephilith-novitiate", "Noviço Cefilita", "Lacaio", 4, 16, "None", 1, 1, 1],
  ["cephilith-priest", "Sacerdote Cefilita", "Líder", 4, 20, "37/70", 7, 5, 1],
  ["cephilith-titan", "Titã Cefilita", "Solo", 4, 20, "38/68", 10, 10, 1],
  ["cipactli", "Cipactli", "Solo", 4, 20, "35/60", 8, 5, 1],
  ["cloud-titan", "Titã das Nuvens", "Manipulador", 4, 18, "26/42", 6, 5, 1],
  ["demon-lord-berzug", "Lorde Demônio Berzug", "Solo", 4, 20, "35/70", 12, 8, 1],
  ["dragon-mother-mitera", "Mãe dos Dragões Mitera", "Solo", 4, 16, "35/65", 12, 10, 1],
  ["fire-titan-warlord", "Titã de Fogo Senhor da Guerra", "Líder", 4, 21, "33/66", 9, 8, 1],
  ["gargantuan-war-machine", "Máquina de Guerra Colossal", "Solo", 4, 20, "48/88", 10, 6, 1],
  ["ghastly-legion", "Legião Fantasmal", "Horda", 4, 17, "25/45", 8, 5, 0],
  ["griffin", "Grifo", "Comum", 4, 18, "30/45", 6, 4, 0],
  ["hallowed-choir", "Coro Consagrado", "Horda", 4, 17, "24/48", 7, 6, 0],
  ["harbinger-of-death", "Arauto da Morte", "Oportunista", 4, 18, "28/52", 6, 6, 2],
  ["harbinger-of-famine", "Arauto da Fome", "Assistente", 4, 18, "26/42", 6, 5, 1],
  ["harbinger-of-pestilence", "Arauto da Peste", "Líder", 4, 18, "37/70", 7, 8, 2],
  ["harbinger-of-war", "Arauto da Guerra", "Brutamonte", 4, 21, "40/70", 9, 4, 1],
  ["owl-witch", "Bruxa-Coruja", "Assistente", 4, 19, "27/47", 4, 3, 1],
  ["ruby-dragon", "Dragão Rubi", "Comum", 4, 19, "30/50", 6, 4, 1],
  ["severed-shadow", "Sombra Decepada", "Lacaio", 4, 19, "None", 1, 2, 1],
  ["supreme-demiurge-adonix", "Demiurgo Supremo Adonix", "Solo", 4, 20, "35/70", 12, 10, 1],
  ["temporal-enforcer", "Executor Temporal", "Brutamonte", 4, 20, "42/68", 8, 5, 1],
  ["water-mother", "Mãe da Água", "Solo", 4, 20, "40/70", 12, 8, 1],
  ["wyrmfiend", "Demônio Serpentino", "Lacaio", 4, 17, "None", 1, 1, 1],
  ["wyrmlings", "Dragonetes", "Horda", 4, 17, "25/45", 8, 5, 1],
...
const LACAIOS = {
  ...
  "redcap-skinner": 4,
  "viper": 4,
  "entombed-stonemason": 5,
  "fungispunj-sporeling": 6,
  "guahalan-spirit-beast": 5,
  "jack-o-lantern": 4,
  "sprite": 5,
  "cephilith-hatchling": 12,
  "cephilith-novitiate": 12,
  "severed-shadow": 12,
  "wyrmfiend": 13,
};

/**
 * As 453 habilidades que custam recurso ou trazem contagem:
...
const HABILIDADES_COM_CUSTO = [
  ...
  ["banshee", 0, "Espectro", "passiva", 0, 1, 0, "", 0],
  ["banshee", 2, "Tática de Intimidação", "ação", 1, 0, 0, "", 0],
  ["banshee", 3, "Lamento do Desespero", "ação", 0, 1, 0, "", 0],
  ["basilisk", 0, "Petrificar", "ação", 1, 0, 0, "", 0],
  ["basilisk", 1, "CRONCH!", "ação", 0, 1, 0, "", 0],
  ["berserker-alpha", 1, "Late para a Lua", "ação", 1, 0, 0, "", 0],
  ["centaur-warden", 1, "Olho do Sábio", "ação", 0, 1, 0, "", 0],
  ["centaur-warden", 2, "Pisoteio", "ação", 1, 0, 0, "", 0],
  ["chicken-foot-hut", 1, "Ataque Duplo", "ação", 0, 1, 0, "", 0],
  ["dire-pangolati", 1, "Giro de Lâmina", "ação", 1, 0, 0, "", 0],
  ["dire-pangolati", 2, "Lançamento de Lâmina", "ação", 0, 1, 0, "", 0],
  ["doppelhound", 0, "Besta do Piscar", "passiva", 1, 0, 0, "", 0],
  ["doppelhound", 1, "Ataque Duplo", "ação", 0, 1, 0, "", 0],
  ["dragon-knight", 1, "Ataque Saltitante", "ação", 0, 1, 0, "", 0],
  ["dragon-knight", 2, "Retorno", "reação", 1, 0, 0, "", 0],
  ["elephant", 0, "Pisotear", "ação", 0, 1, 0, "", 0],
  ["elephant", 1, "Arremessar", "reação", 1, 0, 0, "", 0],
  ["entombed-cat-beast", 2, "Uivo Estridente", "ação", 0, 1, 0, "", 0],
  ["entombed-empress", 2, "Correntes Apreensivas", "ação", 0, 1, 0, "", 0],
  ["entombed-empress", 3, "Obediência Imortal", "ação", 1, 0, 0, "", 0],
  ["entombed-empress", 4, "Carícia Maldita", "reação", 1, 0, 0, "", 0],
  ["entombed-necropriest", 0, "Revigorar", "ação", 0, 1, 0, "", 0],
  ["entombed-necropriest", 1, "Último Aperto", "ação", 1, 0, 0, "", 0],
  ["entombed-necropriest", 2, "Toque Gélido", "ação", 0, 1, 0, "", 0],
  ["entombed-stonemason", 1, "Ataque em Grupo", "ação", 1, 0, 0, "", 0],
  ["entombed-stonemason", 2, "O Trabalho Nunca Termina", "reação", 1, 0, 0, "", 0],
  ["flock-of-feather-fiends", 1, "Cacofonia Enlouquecedora", "ação", 0, 1, 0, "", 0],
  ["fowlbear", 1, "Ataque Duplo", "ação", 0, 1, 0, "", 0],
  ["fowlbear", 2, "Grasnado Aterrorizante", "ação", 1, 0, 0, "", 0],
  ["fungispunj-sporeling", 1, "Ataque em Grupo", "ação", 1, 0, 0, "", 0],
  ["fungispunj-sporeling", 2, "Formar-se", "ação", 1, 0, 0, "", 0],
  ["fungispunj-sporophore", 0, "Nuvem de Esporos Neurotóxicos", "ação", 0, 1, 0, "", 0],
  ["fungispunj-sporophore", 1, "Reanimador", "ação", 1, 0, 0, "", 0],
  ["giant-octopus", 2, "Agarrar", "ação", 1, 0, 0, "", 0],
  ["giant-octopus", 3, "ESMAGAR", "ação", 0, 1, 0, "", 0],
  ["gobstalker", 2, "Raios de Tentáculo", "ação", 1, 1, 0, "", 0],
  ["gobstalker", 3, "Chupão Lamber", "reação", 1, 0, 0, "", 0],
  ["guahalan-alebrujo", 1, "Sacrifício Guahalan", "ação", 1, 0, 0, "", 0],
  ["guahalan-alebrujo", 2, "Uivo do Guahala", "ação", 0, 1, 0, "", 0],
  ["guahalan-alebrujo", 3, "Rasgar & Dilacerar", "ação", 1, 0, 0, "", 0],
  ["guahalan-alebrujo", 4, "Espetáculo Brutal", "reação", 1, 0, 0, "", 0],
  ["guahalan-fang-lord", 1, "Libertar a Fera", "ação", 1, 0, 0, "", 0],
  ["guahalan-fang-lord", 2, "Chamado do Guahala", "ação", 2, 0, 0, "", 0],
  ["guahalan-shifter", 0, "Liberar a Fera", "ação", 1, 0, 0, "", 0],
  ["guahalan-shifter", 1, "Ataque em Matilha", "ação", 0, 1, 0, "", 0],
  ["guahalan-spirit-beast", 2, "Ataque em Grupo", "ação", 1, 0, 0, "", 0],
  ["guahalan-spirit-singer", 0, "Liberar a Fera", "ação", 1, 0, 0, "", 0],
  ["guahalan-spirit-singer", 1, "Chamador de Feras", "ação", 1, 0, 0, "", 0],
  ["guahalan-spirit-singer", 2, "Fúria dos Espíritos", "ação", 0, 1, 0, "", 0],
  ["guahalan-spirit-singer", 3, "Sacrifício Espiritual", "reação", 1, 0, 0, "", 0],
  ["hill-titan", 4, "Golpe Poderoso", "ação", 1, 0, 0, "", 0],
  ["jack-o-lantern", 1, "Ataque em Grupo", "ação", 1, 0, 0, "", 0],
  ["landshark", 2, "Mordida Dilacerante", "reação", 1, 0, 0, "", 0],
  ["ravenous-mockery", 0, "Ataque com a Língua", "ação", 1, 1, 0, "", 0],
  ["ravenous-mockery", 2, "Nunca Só Um", "ação", 1, 0, 0, "", 0],
  ["scarecrow", 1, "Visão de Terror", "ação", 1, 0, 0, "", 0],
  ["sprite", 1, "Arte da Invisibilidade", "ação", 1, 0, 0, "", 0],
  ["sprite", 2, "Veneno da Pétala dos Sonhos", "ação", 1, 0, 0, "", 0],
  ["stone-titan", 3, "Smashing do Martelo", "ação", 1, 0, 0, "", 0],
  ["triceratops", 1, "Balanço de Cauda", "ação", 0, 1, 0, "", 0],
  ["triceratops", 2, "Investida de Touro", "ação", 0, 1, 0, "", 0],
  ["tyrannosaurus", 0, "Rugido Que Abala a Terra", "ação", 1, 0, 0, "", 0],
  ["tyrannosaurus", 1, "Pisotear", "ação", 0, 1, 0, "", 0],
  ["tyrannosaurus", 2, "Mordida Esmagadora", "reação", 1, 0, 0, "", 0],
  ["urco", 3, "Olhar Ameaçador", "reação", 1, 0, 0, "", 0],
  ["valdenhax", 1, "Estrangulador Sombrio", "ação", 0, 1, 0, "", 0],
  ["valdenhax", 2, "Sussurrador de Cadáveres", "ação", 1, 0, 0, "", 0],
  ["archmage", 4, "Contra-feitiço", "reação", 1, 0, 0, "", 0],
  ["catrin", 1, "O Peso da Opulência", "ação", 1, 0, 0, "", 0],
  ["catrin", 2, "Falha Cara", "reação", 0, 1, 0, "", 0],
  ["chimera", 1, "Garra Dupla", "ação", 0, 1, 0, "", 0],
  ["chimera", 2, "Sopro de Fogo", "ação", 1, 0, 0, "", 0],
  ["chimera", 3, "Golpe da Serpente", "reação", 0, 1, 0, "", 0],
  ["crimson-lepus", 3, "Golpe Ascendente na Jugular", "ação", 1, 0, 0, "", 0],
  ["cryptimoth", 1, "Grito Psíquico", "ação", 2, 1, 0, "", 0],
  ["cryptimoth", 2, "Enxame Sombrio", "ação", 1, 1, 0, "", 0],
  ["cryptimoth", 3, "Olhar Paranóico", "ação", 1, 0, 0, "", 0],
  ["cursed-merfolk", 2, "“Venha Cá!”", "reação", 1, 1, 0, "", 0],
  ["deep-dweller", 0, "Explosão Psíquica", "ação", 1, 1, 0, "", 0],
  ["deep-dweller", 1, "Dreno Cerebral", "ação", 0, 1, 0, "", 0],
  ["deep-dweller", 2, "Chamado das Profundezas", "ação", 2, 0, 0, "", 0],
  ["drake", 1, "Cão de Guarda", "reação", 0, 1, 0, "", 0],
  ["dullahan", 0, "Espectro", "passiva", 0, 1, 0, "", 0],
  ["dullahan", 1, "Monte Espectral", "passiva", 0, 1, 0, "", 0],
  ["dullahan", 2, "Ataque com Chicote de Ossos", "ação", 0, 1, 0, "", 0],
  ["dullahan", 3, "Olhar da Morte", "ação", 1, 1, 0, "", 0],
  ["fellmounted-shadow-king", 0, "Montaria Maldita", "passiva", 0, 1, 0, "", 0],
  ["fellmounted-shadow-king", 3, "Canto Infernal", "ação", 2, 1, 0, "", 0],
  ["fellmounted-shadow-king", 4, "Apoio Aéreo", "reação", 1, 0, 0, "", 0],
  ["fire-titan", 3, "Arremesso de Pedra", "ação", 0, 1, 0, "", 0],
  ["fire-titan", 4, "Quebra-Crânio", "ação", 0, 1, 0, "", 0],
  ["fire-titan", 5, "Coração Flamejante", "reação", 1, 0, 0, "", 0],
  ["frost-titan", 1, "Berrante de Guerra", "ação", 0, 1, 0, "", 0],
  ["frost-titan", 2, "Investida", "ação", 0, 1, 0, "", 0],
  ["frost-titan", 3, "Golpe Devastador", "reação", 0, 1, 0, "", 0],
  ["gargantuan-sea-turtle", 2, "Golpe de Cauda", "ação", 0, 1, 0, "", 0],
  ["gargantuan-sea-turtle", 3, "Onda Colossal", "ação", 1, 1, 0, "", 0],
  ["gargantuan-sea-turtle", 4, "Sopro de Vapor", "ação", 2, 1, 0, "", 0],
  ["lamia", 0, "Constrição", "ação", 0, 1, 0, "", 0],
  ["lamia", 1, "Drenagem de Vida", "ação", 0, 1, 0, "", 0],
  ["lamia", 2, "Toxina do Sono", "reação", 1, 0, 0, "", 0],
  ["lamplight-beguiler", 0, "Isca Duplicada", "ação", 0, 1, 0, "", 0],
  ["lamplight-beguiler", 1, "Seduzir", "ação", 1, 0, 0, "", 0],
  ["lamplight-beguiler", 2, "Engolir", "reação", 1, 0, 0, "", 0],
  ["manticore", 3, "Ataque Saltador", "ação", 1, 0, 0, "", 0],
  ["manticore", 4, "Espinho de Cauda Paralisante", "ação", 0, 1, 0, "", 0],
  ["manticore", 5, "Mandíbulas Trancadas", "reação", 0, 1, 0, "", 0],
  ["night-children", 2, "Sobrepujar", "reação", 0, 1, 0, "", 0],
  ["pain-priest", 0, "Caminhar Entre Mundos", "ação", 0, 1, 0, "", 0],
  ["plesiosaurus", 1, "Parede de Água", "ação", 0, 1, 0, "", 0],
  ["roc", 2, "Lá Vem o Estrondo", "ação", 1, 1, 0, "", 0],
  ["roc", 3, "Garra Aplastante", "reação", 0, 1, 0, "", 0],
  ["sandwyrm", 0, "Ferrão venenoso na cauda", "ação", 0, 1, 0, "", 0],
  ["shapeshifting-fiend", 1, "Personificar", "ação", 1, 1, 0, "", 0],
  ["shapeshifting-fiend", 2, "Tornar-se Invisível", "ação", 0, 1, 0, "", 0],
  ["shapeshifting-fiend", 3, "Orientação Disfarçada", "reação", 0, 1, 0, "", 0],
  ["shapeshifting-fiend-revealed", 2, "Fúria Demoníaca", "ação", 1, 0, 0, "", 0],
  ["shapeshifting-fiend-revealed", 3, "Salão de Espelhos", "ação", 0, 2, 0, "", 0],
  ["shapeshifting-fiend-revealed", 4, "Garra Relâmpago", "ação", 1, 0, 0, "", 0],
  ["shapeshifting-fiend-revealed", 5, "Jogos Mentais", "reação", 0, 1, 0, "", 0],
  ["storm-titan", 2, "Bola de Raio", "ação", 1, 0, 0, "", 0],
  ["storm-titan", 3, "Portador da Tempestade", "ação", 0, 1, 0, "", 0],
  ["storm-titan", 4, "Estrondo do Trovão", "ação", 1, 0, 0, "", 0],
  ["unicorn", 2, "Aura Protetora", "ação", 0, 1, 0, "", 0],
  ["unicorn", 3, "Teleporte", "ação", 0, 1, 0, "", 0],
  ["vampire-bat-swarm", 2, "Sugadores de Sangue", "reação", 0, 1, 0, "", 0],
  ["vampire-lord", 3, "Libere Fogo do Inferno", "ação", 0, 1, 0, "", 0],
  ["vampire-lord", 4, "Ressurgimento", "reação", 1, 0, 0, "", 0],
  ["vampire-lord", 5, "Derreta-se na Sombra", "reação", 1, 0, 0, "", 0],
  ["viscera-sucker", 1, "Entranhas Entrelaçadas", "ação", 1, 0, 0, "", 0],
  ["viscera-sucker", 2, "Suga-vida", "ação", 0, 1, 0, "", 0],
  ["whisper-wraith", 1, "Assustador", "passiva", 0, 1, 0, "", 0],
  ["whisper-wraith", 2, "Manto do Pesadelo", "ação", 1, 0, 0, "", 0],
  ["wyvern", 0, "Ataque Duplo", "ação", 0, 1, 0, "", 0],
  ["wyvern", 1, "Grito Aterrorizante", "ação", 1, 0, 0, "", 0],
  ["wyvern", 2, "Garra", "reação", 1, 0, 0, "", 0],
  ["young-fire-dragon", 1, "Intimidante", "passiva", 1, 1, 0, "", 0],
  ["young-fire-dragon", 2, "Sopro de Fogo", "ação", 1, 1, 0, "", 0],
  ["young-fire-dragon", 3, "Erupção", "ação", 1, 0, 0, "", 0],
  ["young-fire-dragon", 4, "Escamas Flamejantes", "reação", 0, 1, 0, "", 0],
  ["young-fire-dragon", 5, "Cortar e Queimar", "reação", 0, 1, 0, "", 0],
  ["cephilith-abomination", 1, "Abraço de Urso", "ação", 0, 1, 0, "", 0],
  ["cephilith-abomination", 2, "Quebrar!", "ação", 1, 0, 0, "", 0],
  ["cephilith-abomination", 3, "Ataque com Língua", "ação", 1, 0, 0, "", 0],
  ["cephilith-hatchling", 1, "Comatizar", "ação", 1, 1, 0, "", 0],
  ["cephilith-hatchling", 2, "Ataque em Grupo", "ação", 1, 0, 0, "", 0],
  ["cephilith-novitiate", 1, "Ataque em Grupo", "ação", 1, 0, 0, "", 0],
  ["cephilith-novitiate", 2, "Sacrificar-se", "ação", 1, 0, 0, "", 0],
  ["cephilith-priest", 0, "Explosão Psíquica", "ação", 1, 0, 0, "", 0],
  ["cephilith-priest", 1, "Invasão Cerebral", "ação", 1, 0, 0, "", 0],
  ["cephilith-priest", 2, "Garra Telecinética", "reação", 0, 1, 0, "", 0],
  ["cephilith-titan", 3, "Grito Psíquico", "ação", 1, 1, 0, "", 0],
  ["cephilith-titan", 4, "Invocar Adoradores", "ação", 1, 0, 0, "", 0],
  ["cipactli", 1, "Muitas Bocas", "ação", 0, 1, 0, "", 0],
  ["cipactli", 2, "Alimentação Frenética", "ação", 1, 0, 0, "", 0],
  ["cipactli", 3, "Passos Sísmicos", "ação", 0, 1, 0, "", 0],
  ["cloud-titan", 0, "Golpe de Relâmpago", "ação", 0, 1, 0, "", 0],
  ["cloud-titan", 1, "Tecelão de Névoa", "ação", 1, 0, 0, "", 0],
  ["cloud-titan", 2, "Transformação Nebulosa", "ação", 0, 1, 0, "", 0],
  ["cloud-titan", 4, "Moldador de Ventos", "ação", 1, 0, 0, "", 0],
  ["demon-lord-berzug", 1, "Chicote do Caos", "ação", 0, 1, 0, "", 0],
  ["demon-lord-berzug", 2, "Contemple o Abismo", "ação", 1, 1, 0, "", 0],
  ["demon-lord-berzug", 3, "Golpe Esmagador", "reação", 0, 1, 0, "", 0],
  ["dragon-mother-mitera", 2, "Sopro Elemental", "ação", 0, 1, 0, "", 0],
  ["dragon-mother-mitera", 3, "Golpe de Cauda", "ação", 1, 1, 0, "", 0],
  ["fire-titan-warlord", 2, "Liberar os Cães", "ação", 1, 0, 0, "", 0],
  ["fire-titan-warlord", 3, "Golpe Giratório", "ação", 0, 1, 0, "", 0],
  ["fire-titan-warlord", 4, "Quebra-Terra", "ação", 1, 0, 0, "", 0],
  ["gargantuan-war-machine", 2, "Soco-Foguete", "ação", 0, 1, 0, "", 0],
  ["gargantuan-war-machine", 3, "Pisada Quebra-Terra", "ação", 1, 0, 0, "", 0],
  ["harbinger-of-death", 1, "Montaria", "passiva", 0, 1, 0, "", 0],
  ["harbinger-of-death", 3, "Decapitar", "ação", 2, 0, 0, "", 0],
  ["harbinger-of-death", 4, "Despertar os Caídos", "ação", 1, 0, 0, "", 0],
  ["harbinger-of-death", 5, "Cinzas às Cinzas, Pó ao Pó", "reação", 0, 1, 0, "", 0],
  ["harbinger-of-famine", 1, "Montaria", "passiva", 0, 1, 0, "", 0],
  ["harbinger-of-famine", 2, "Pontadas de Fome", "passiva", 0, 1, 0, "", 0],
  ["harbinger-of-famine", 3, "Drenar Essência", "ação", 1, 0, 0, "", 0],
  ["harbinger-of-famine", 4, "Bocas Demais", "ação", 0, 1, 0, "", 0],
  ["harbinger-of-famine", 5, "Toque Murchante", "ação", 1, 0, 0, "", 0],
  ["harbinger-of-pestilence", 1, "Montaria", "passiva", 0, 1, 0, "", 0],
  ["harbinger-of-pestilence", 2, "Enxame de Gafanhotos", "ação", 2, 0, 0, "", 0],
  ["harbinger-of-pestilence", 3, "Ovos de Sapo", "ação", 1, 0, 0, "", 0],
  ["harbinger-of-war", 1, "Montaria", "passiva", 0, 1, 0, "", 0],
  ["harbinger-of-war", 2, "Dados de Ferro", "ação", 0, 1, 0, "", 0],
  ["harbinger-of-war", 3, "Comandante Supremo", "ação", 1, 0, 0, "", 0],
  ["harbinger-of-war", 4, "Aríete", "reação", 1, 0, 0, "", 0],
  ["owl-witch", 2, "Imitação de Voz", "ação", 1, 0, 0, "", 0],
  ["owl-witch", 3, "Olhar de Pesadelo", "ação", 1, 0, 0, "", 0],
  ["owl-witch", 4, "Visões de um Fim Violento", "reação", 1, 0, 0, "", 0],
  ["ruby-dragon", 2, "Sopro derretedor", "ação", 0, 1, 0, "", 0],
  ["ruby-dragon", 3, "Fissura Vulcânica", "ação", 1, 0, 0, "", 0],
  ["severed-shadow", 1, "Agarrar Sombra", "ação", 0, 1, 0, "", 0],
  ["severed-shadow", 2, "Ataque em Grupo", "ação", 1, 0, 0, "", 0],
  ["supreme-demiurge-adonix", 1, "Arconte Elemental", "ação", 0, 1, 0, "", 0],
  ["supreme-demiurge-adonix", 3, "Adonix ganha as seguintes características nesta forma: Abandonado", "ação", 1, 0, 0, "", 0],
  ["temporal-enforcer", 2, "Mover Entre Momentos", "ação", 0, 1, 0, "", 0],
  ["temporal-enforcer", 3, "Recuo Instantâneo", "reação", 1, 0, 0, "", 0],
  ["temporal-enforcer", 4, "Inverter Polaridade", "reação", 1, 0, 0, "", 0],
  ["water-mother", 1, "Coma o Mundo", "ação", 1, 1, 0, "", 0],
  ["water-mother", 2, "Constrição", "ação", 0, 1, 0, "", 0],
  ["water-mother", 3, "Surto de Veneno", "reação", 1, 0, 0, "", 0],
  ["wyrmfiend", 1, "Mordida Venenosa", "ação", 1, 1, 0, "", 0],
  ["wyrmfiend", 2, "Ataque em Grupo", "ação", 1, 0, 0, "", 0],
  ["wyrmlings", 1, "Voraz", "reação", 1, 0, 0, "", 0],
  ["wyrmlings", 2, "Sobrepujar", "reação", 0, 1, 0, "", 0],
  ["xero-the-castle-killer", 2, "Pisada Gigaton", "ação", 1, 0, 0, "", 0],
  ["xero-the-castle-killer", 3, "Investida Poderosa", "ação", 0, 1, 0, "", 0],
  ["xero-the-castle-killer", 4, "Sopro Radioativo", "ação", 1, 0, 0, "", 0],
];
