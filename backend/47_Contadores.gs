...
const CONTADORES = {
  ...
  "uso:bardo-musico-errante:interprete-talentoso": { origem: "caracteristica-subclasse", refId: "bardo-musico-errante", nome: "Intérprete Talentoso", rotulo: "já usou", tipo: "usos", maximo: {"tipo":"fixo","valor":1}, zeraEm: ["descanso-longo"], recarregaEm: [], exigeCaracteristica: "Intérprete Talentoso" },
