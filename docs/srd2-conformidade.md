...
No checkpoint atual, 1.526 registros estão como `mecanica-implementada`, 1 como `fonte-conferida` e 12 permanecem `pendente`. Das 224 fontes da coleção `rules`, 212 foram vinculadas e conferidas; restam somente os 12 módulos de campanhas suplementares.
