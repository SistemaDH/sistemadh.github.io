...
if([...inv.values()].filter(x=>x.estado==='pendente').length!==135){console.error('total pendente divergente');process.exit(1)}
console.log('SRD2: 129 adversários existentes vinculados; 135 adicionais pendentes.');
