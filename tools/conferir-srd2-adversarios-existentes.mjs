...
if([...inv.values()].filter(x=>x.estado==='pendente').length!==27){console.error('total pendente divergente');process.exit(1)}
console.log('SRD2: 129 adversários existentes vinculados; 108 novos integrados e 27 adicionais pendentes.');
