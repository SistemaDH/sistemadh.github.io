...
if([...inv.values()].filter(x=>x.estado==='pendente').length!==0){console.error('total pendente divergente');process.exit(1)}
console.log('SRD2: 129 adversários existentes vinculados e 135 novos integrados; coleção completa.');
