...
if([...inv.values()].filter(x=>x.estado==='pendente').length!==101){console.error('total pendente divergente');process.exit(1)}
console.log('SRD2: 129 adversários existentes vinculados; 34 novos integrados e 101 adicionais pendentes.');
