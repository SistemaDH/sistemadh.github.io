...
s=s.replace("'Invigorating': 1, 'Lifestealing': 1, 'Quick': 6, 'QuickCampaign': 5\n", "'Invigorating': 1, 'Lifestealing': 1, 'Quick': 6, 'QuickCampaign': 5, 'StartlingCampaign': 1\n")
s=s.replace("igual(alvos.length,19,'4 Alarmante + Persuasão + Repelente + Revigorante + Sorvedouras + 6 Quick + 5 molduras');", "igual(alvos.length,20,'5 Alarmante + Persuasão + Repelente + Revigorante + Sorvedouras + 6 Quick + 5 Veloz de moldura');")
