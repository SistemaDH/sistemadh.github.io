...
if(prep.corpusCommit!==inventory.corpusCommit||prep.registros.length!==135||new Set(prep.registros.map(x=>x.id)).size!==135)errors.push('preparação incompleta');
...
if(errors.length){console.error(errors.join('\n'));process.exit(1)}console.log('SRD2: 135 adversários adicionais preparados sem exposição.');
