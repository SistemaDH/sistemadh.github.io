...
const implementados = new Set([
  ...
  'armor/improved-scale-mail-armor',
  'armor/improved-banded-armor',
  'armor/enchanters-robes',
  'armor/hawkguards-mantle',
  'armor/spidersilk-tunic',
  ...
  'armor/advanced-scale-mail-armor',
  ...
  'armor/veritas-opal-armor',
  'armor/savior-chainmail',
  'beastforms/agile-scout',
  'beastforms/aquatic-predator',
  'beastforms/aquatic-scout',
  'beastforms/armored-sentry',
  'beastforms/epic-aquatic-beast',
  'beastforms/great-predator',
  'beastforms/great-winged-beast',
  'beastforms/household-friend',
  'beastforms/legendary-beast',
  'beastforms/legendary-hybrid',
  'beastforms/massive-behemoth',
  'beastforms/mighty-lizard',
  'beastforms/mighty-strider',
  'beastforms/mythic-aerial-hunter',
  'beastforms/mythic-beast',
  'beastforms/mythic-hybrid',
  'beastforms/nimble-grazer',
  'beastforms/pack-predator',
  'beastforms/pouncing-predator',
  'beastforms/powerful-beast',
  'beastforms/stalking-arachnid',
  'beastforms/striking-serpent',
  'beastforms/terrible-lizard',
  'beastforms/winged-beast',
  'rules/leveling-up',
  'rules/multiclassing',
  'domains/arcana',
  'domains/blade',
  ...
  'domain-cards/forceful-push',
  'domain-cards/i-am-your-shield',
  'domain-cards/bare-bones',
